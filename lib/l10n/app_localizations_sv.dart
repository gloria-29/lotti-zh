...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String agentSummaryCreateFollowUp(Object title) {
    return 'Skapa uppföljningsuppgift: ”$title”';
  }

  @override
  String agentSummaryCreateFollowUpRelated(Object title, Object relation) {
    return 'Skapa uppföljningsuppgift: ”$title” — $relation';
  }
  ...
  @override
  String get agentSummaryRecommendNextSteps => 'Rekommendera nästa steg';
  ...
  String agentSummaryRecommendNextStepsCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Rekommendera $count nästa steg',
      one: 'Rekommendera 1 nästa steg',
    );
    return '$_temp0';
  }
  ...
  String agentSummaryReviseTimeEntryText(Object summary) {
    return 'Revidera texten i tidsposten: ”$summary”';
  }

  @override
  String agentSummarySetDueDate(Object date) {
    return 'Sätt förfallodatumet till $date';
  }
  ...
  String agentSummarySetEstimate(int minutes) {
    String _temp0 = intl.Intl.pluralLogic(
      minutes,
      locale: localeName,
      other: 'Sätt uppskattningen till $minutes minuter',
      one: 'Sätt uppskattningen till 1 minut',
    );
    return '$_temp0';
  }
  ...
  String agentSummaryUpdateProjectStatus(Object status) {
    return 'Sätt projektstatus till $status';
  }
  ...
  @override
  String get aiProviderSherpaName => 'sherpa-onnx (på enheten)';
  ...
  String get aiSkillNoProfileConfigured =>
      'Ingen AI-profil är uppsatt för den här posten, så inget kunde köras.';
  ...
  String get aiTranscriptionNoModelConfigured =>
      'Ingen tal-till-text-modell är uppsatt än, så den här inspelningen kunde inte transkriberas. Lägg till en under AI-inställningar och tryck sedan på Försök igen.';
  ...
  @override
  String get checkInMoreCaptionFeeling => 'Känsla';

  @override
  String get checkInMoreCaptionNextTime => 'nästa gång';

  @override
  String get checkInMoreCaptionNextTimeSet => 'nästa gång noterat';

  @override
  String get checkInMoreCaptionTopics => 'ämnen';
  ...
  String get configFlagEnableAiSummaryTtsDescription =>
      'Visa den lokala text-till-tal-knappen på sammanfattningar av uppgift-AI. Kräver en installerad Supertonic TTS-modell.';
  ...
  @override
  String get demoAiNudgeCancel => 'Inte nu';

  @override
  String get demoAiNudgeConfirm => 'Ställ in riktig AI';

  @override
  String get demoAiNudgeTitle => 'AI:n i demon är på låtsas';

  @override
  String get demoAiSetupSuccessBody =>
      'Den här demovärlden använder nu ditt riktiga AI-konto. Din nyckel stannar här om du inte kopierar över den när du lämnar.';

  @override
  String get demoAiSetupSuccessTitle => 'Riktig AI är aktiv';
  ...
  String get demoCopyBody =>
      'Välj vilka uppgifter och inlägg du vill kopiera till din dagbok.';
  ...
  @override
  String get demoCopySectionAiSetup => 'AI-inställning';

  @override
  String get demoCopySectionEntries => 'Dagboksinlägg';

  @override
  String get demoCopySectionTasks => 'Uppgifter';

  @override
  String get demoCopySelectAll => 'Markera alla';

  @override
  String get demoCopyTitle => 'Ta med mitt arbete';
  ...
  String demoCopyToast(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count objekt kopierade till din dagbok',
      one: '1 objekt kopierat till din dagbok',
    );
    return '$_temp0';
  }
  ...
  String get demoExitSheetBody =>
      'Din demovärld sparas — du kan komma tillbaka när som helst.';

  @override
  String get demoExitSheetTitle => 'Lämna demon?';
  ...
  @override
  String get demoMediaDownloadProgress => 'Hämtar demobilder';

  @override
  String get demoMediaDownloadRetry =>
      'Vissa demobilder kunde inte hämtas. Ett nytt försök görs vid nästa start.';
  ...
  String get demoSettingsDeleteConfirm =>
      'Radera demovärlden och alla dess data?';

  @override
  String get demoSettingsDeleteTitle => 'Radera demodata';

  @override
  String get demoSettingsDeleteToast => 'Demodata raderade';
  ...
  String get demoSettingsRealAiSubtitle =>
      'Använd ditt eget AI-konto i demovärlden';

  @override
  String get demoSettingsRealAiTitle => 'Aktivera riktig AI i demon';

  @override
  String get demoSettingsResetConfirm =>
      'Återställ demovärlden? Alla dina ändringar där går förlorade.';

  @override
  String get demoSettingsResetTitle => 'Återställ demodata';
  ...
  String get demoSettingsTrySubtitle =>
      'Utforska Lotti med exempeldata — din dagbok förblir orörd';

  @override
  String get demoSettingsTryTitle => 'Prova demovärlden';

  @override
  String get demoTryButton => 'Prova demon';
  ...
  String get goalAssessmentPerDimension =>
      'Betygsätt individuella dimensioner (valfritt)';

  @override
  String get goalAssessmentRecorded => 'Inspelad';

  @override
  String goalAssessmentRecordFor(String dayName) {
    return 'Rekord för $dayName';
  }

  @override
  String get goalAssessmentReflectToday => 'Reflektera över idag';

  @override
  String goalAssessmentSpecVersion(int version) {
    return 'Mål v$version tillämpat';
  }
  ...
  String get goalCheckInTranscriptionOff =>
      'Automatiska uppdateringar är av för det här målet, så din avstämning transkriberades inte. Tryck på Försök igen för att transkribera den nu.';
  ...
  String goalDimensionHabitReading(int currentCount, int targetCount) {
    return '$currentCount av $targetCount detta fönster';
  }
  ...
  String goalDimensionMetricReading(String currentValue, String targetValue) {
    return '$currentValue av $targetValue';
  }
  ...
  String goalDimensionMetricReadingWithUnit(
    ...
    return '$currentValue av $targetValue $unitName';
  }
  ...
  String get goalDimensionRecordedByAgent =>
      'Sagt av dig och inspelat efter ditt godkännande.';
  ...
  @override
  String get goalFormCompositeAll => 'Alla dimensioner';

  @override
  String get goalFormCompositeAllHint =>
      'Striktast – varje dimension måste uppfyllas.';

  @override
  String get goalFormCompositeAny => 'Vilken dimension som helst';

  @override
  String get goalFormCompositeAnyHint =>
      'Lösast — en uppfylld dimension räcker.';

  @override
  String goalFormCompositeAtLeast(int requiredCount, int dimensionCount) {
    return 'Åtminstone $requiredCount av $dimensionCount';
  }

  @override
  String get goalFormCompositeAtLeastHint =>
      'Välj hur många dimensioner som ska uppfyllas.';

  @override
  String get goalFormCompositeRule => 'Hur detta mål går ihop';
  ...
  @override
  String get goalFormDirectionAtMost => 'Högst';
  ...
  @override
  String get goalFormHealthBloodPressureSystolic => 'Systoliskt blodtryck';
  ...
  String goalFormHealthCadence(
    ...
    return '$healthName: 7-dagarsgenomsnitt $direction $target $unitName';
  }
  ...
  String goalFormHealthSource(String unitName) {
    return 'Hälsodata · $unitName · 7-dagarsgenomsnitt';
  }
  ...
  @override
  String get goalFormHealthWeight => 'Vikt';
  ...
  String get goalFormLabelTimeSource =>
      'Registrerad tid med den här etiketten · timmar per dag';

  @override
  String get goalFormLabelTimeTarget => 'Timmar per dag';
  ...
  String goalFormMeasurableCadence(String measurableName, String target) {
    return '$measurableName: $target per rullande vecka';
  }

  @override
  String goalFormMeasurableSource(String unitName) {
    return 'Din mätbara · $unitName';
  }
  ...
  String goalPatternBusiestHour(String hour) {
    return 'De flesta sessioner börjar runt $hour:00. Öppna insikter för djupare analys.';
  }
  ...
  String get goalRecordOfferIntro =>
      'Jag hittade en mängd i det du sa. Kontrollera värdena innan något registreras.';
  ...
  String get goalRecordOfferNothingSelected =>
      'Välj minst en rad att spela in.';

  @override
  String goalRecordOfferOverline(String agentName, String measurableName) {
    return '$agentName FÖRESLÅR · REGISTRERA I $measurableName';
  }

  @override
  String goalRecordOfferProvenance(String agentName) {
    return 'Sagt av dig, inspelat av $agentName';
  }
  ...
  String goalRecordOfferReceipt(int entryCount, String agentName) {
    ...
    return 'Inspelat · $_temp0 · sagt av dig, inspelat av $agentName';
  }
  ...
  @override
  String get habitHealthBloodPressureSystolic => 'Systoliskt blodtryck';

  @override
  String get habitHealthBodyFat => 'Kroppsfett';

  @override
  String get habitHealthBodyMassIndex => 'Body mass index';

  @override
  String get habitHealthDistance => 'Sträcka';

  @override
  String get habitHealthFlightsClimbed => 'Våningar';

  @override
  String get habitHealthHeartRateVariability => 'Pulsvariabilitet';

  @override
  String get habitHealthRestingHeartRate => 'Vilopuls';

  @override
  String get habitHealthSleepAsleep => 'Sömn';

  @override
  String get habitHealthSleepAwake => 'Vaken i sängen';

  @override
  String get habitHealthSleepDeep => 'Djupsömn';

  @override
  String get habitHealthSleepInBed => 'Tid i sängen';

  @override
  String get habitHealthSleepLight => 'Lätt sömn';

  @override
  String get habitHealthSleepRem => 'REM-sömn';

  @override
  String get habitHealthSteps => 'Steg';

  @override
  String get habitHealthWalkingHeartRate => 'Puls vid promenad';

  @override
  String get habitHealthWeight => 'Vikt';
  ...
  @override
  String get knowledgeGraphDensity => 'Täthet';

  @override
  String get knowledgeGraphDensityBalanced => 'Balanserad';

  @override
  String get knowledgeGraphDensityCalm => 'Lugn';

  @override
  String get knowledgeGraphDensityExplore => 'Utforska';
  ...
  @override
  String get knowledgeGraphLast30Days => 'Senaste 30 dagarna';

  @override
  String get knowledgeGraphLast7Days => 'Senaste 7 dagarna';

  @override
  String get knowledgeGraphLast90Days => 'Senaste 90 dagarna';
  ...
  @override
  String get knowledgeGraphOneHop => '1 steg';

  @override
  String get knowledgeGraphOpenDetails => 'Öppna detaljer';

  @override
  String get knowledgeGraphOpenPhoto => 'Visa fotot i helskärm';
  ...
  @override
  String get knowledgeGraphTopologyOverview => 'Topologiöversikt';

  @override
  String get knowledgeGraphTwoHops => '2 steg';

  @override
  String get knowledgeGraphViewConnections => 'Anslutningar';
  ...
  @override
  String get matrixStatsQueueActive => 'Kö (aktiv)';
  ...
  String get provisionedSyncErrorConfigurationFailed =>
      'Något gick fel vid anslutningen. Försök igen; om det fortsätter misslyckas, kontrollera att den andra enheten fortfarande synkar.';
  ...
  @override
  String get provisionedSyncLoggingIn => 'Ansluter till ditt synkkonto…';
  ...
  @override
  String get provisionedSyncSummaryUser => 'Synkkonto';
  ...
  String relationshipAgentNoBriefingBody(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Ingen briefing än. „Briefa nu“ skriver en utifrån dina $count avstämningar; den ser aldrig telefonnummer eller e-post.',
      one:
          'Ingen briefing än. „Briefa nu“ skriver en utifrån din avstämning; den ser aldrig telefonnummer eller e-post.',
      zero:
          'Ingen briefing än. „Briefa nu“ skriver en så fort du loggat en avstämning; den ser aldrig telefonnummer eller e-post.',
    );
    return '$_temp0';
  }
  ...
  String relationshipAgentNotEnrolledBody(String name) {
    return 'Markera $name som viktig för att få en chatt, påminnelser när det gått ett tag och en briefing.';
  }
  ...
  String relationshipImportReviewSubtitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count personer valda · kontaktuppgifterna stannar på den här enheten',
      one: '1 person vald · kontaktuppgifterna stannar på den här enheten',
    );
    return '$_temp0';
  }
  ...
  String get settingsSystemHealthSubtitle =>
      'Analysera de senaste loggarna och kopiera en delbar rapport';

  @override
  String get settingsSystemHealthTitle => 'Systemstatus';
  ...
  String get syncAddDeviceRosterError =>
      'Det gick inte att kontrollera om den nya enheten har anslutit.';
  ...
  @override
  String get syncPairBack => 'Tillbaka';

  @override
  String get syncPairCameraDenied =>
      'Lotti behöver kameraåtkomst för att skanna. Tillåt det i systeminställningarna, eller ange koden manuellt.';

  @override
  String get syncPairCameraRetry => 'Försök med kameran igen';

  @override
  String get syncPairCheckAgain => 'Kontrollera igen';
  ...
  String get syncPairClipboardEmpty =>
      'Det finns inget att klistra in. Kopiera först parkopplingskoden på din andra enhet.';
  ...
  String get syncPairErrorMalformed =>
      'Det ser inte ut som en parkopplingskod. Kontrollera att du kopierade hela – tryck på Kopiera parkopplingskod igen på den andra enheten.';
  ...
  @override
  String get systemHealthCustomFromLabel => 'Från';

  @override
  String get systemHealthCustomToLabel => 'Till';
  ...
  String get systemHealthDomainsDescription =>
      'De domäner som är påslagna här analyseras – samma inställning som avgör vad som loggas. Långsamma frågor tas med när loggning av dem är på.';

  @override
  String get systemHealthDomainsTitle => 'Loggdomäner';
  ...
  String get systemHealthModelDescription =>
      'Skriver slutsatserna utifrån den anonymiserade sammanfattningen. Föreslår tankemodellen i din standardprofil.';

  @override
  String get systemHealthModelNone => 'Bara sammanfattning, ingen modell';

  @override
  String get systemHealthModelNoneDescription =>
      'Ange en standardprofil för inferens eller lägg till en agentisk textmodell för att få slutsatser.';

  @override
  String get systemHealthModelTitle => 'Modell';

  @override
  String get systemHealthPresetCustom => 'Anpassat';

  @override
  String get systemHealthPresetLast14Days => '14 dagar';
  ...
  @override
  String get systemHealthRunButton => 'Kör analys';

  @override
  String systemHealthSavedTo(String path) {
    return 'Sparad i $path';
  }

  @override
  String get systemHealthShowDigest => 'Visa sammanfattning';
  ...
  @override
  String get taskMetaEstimateLabel => 'Uppskattning';
  ...
  @override
  String get unifiedGoalStatusNoData => 'Inga data';
  ...
  String unifiedGoalSummaryAllOnTrack(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Alla $count vanor är på rätt spår – inget behövs i dag.',
      one: 'Din vana är på rätt spår – inget behövs i dag.',
    );
    return '$_temp0';
  }
  ...
  String get unifiedGoalSummaryNoData =>
      'Inga data ännu – logga en vana eller koppla en signal för att komma igång.';
  ...
  @override
  String get unifiedGoalsUngroupedHabitsHeader => 'Utan mål';
